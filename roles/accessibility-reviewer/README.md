<[Title]>
## Purpose
Standardizes the readme for the Accessibility Reviewer role to ensure high-quality engineering outcomes.
...
- **No Shortcuts**: Must never skip required steps in the readme process.
