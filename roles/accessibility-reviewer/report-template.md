<[Title]>
## Purpose
Standardizes the report template for the Accessibility Reviewer role to ensure high-quality engineering outcomes.
...
- **No Shortcuts**: Must never skip required steps in the report template process.
