<[Title]>
## Purpose
Standardizes the outputs for the Accessibility Reviewer role to ensure high-quality engineering outcomes.
...
- **No Shortcuts**: Must never skip required steps in the outputs process.
